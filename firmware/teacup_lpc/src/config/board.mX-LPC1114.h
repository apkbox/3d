...
//            name      pin      invert  pwm
DEFINE_HEATER(extruder, PIO1_10, 0,      20000)
...
*/
#define DISPLAY_RS_PIN           PIO3_2
#define DISPLAY_RW_PIN           PIO3_1
#define DISPLAY_E_PIN            PIO3_0
#define DISPLAY_D4_PIN           PIO2_6
#define DISPLAY_D5_PIN           PIO2_7
#define DISPLAY_D6_PIN           PIO2_8
#define DISPLAY_D7_PIN           PIO2_9
